...
features = [
    ...
    'Hour',
    'Is_Daytime',
    'OutsideWeather_Humidity_Pct',
    'Indoor_Humidity_Pct',
    'Pressure_mmHg',
    'Indoor_Humidity_Deviation',
    'Season',
    'Humidity_Deviation',
    'Is_Weekend'
]

target = 'Energy_HVAC_Wh'
...
joblib.dump(model, r"C:\Users\Laptop World\model_hvac_xgb_3y.pkl")
joblib.dump(scaler, r"C:\Users\Laptop World\scaler_hvac_3y.pkl")